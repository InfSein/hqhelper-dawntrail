    ...
    <div>
      <FoldableCard card-key="ft-item-selection">
        ...
        <n-tabs v-model:value="workState.mode" type="segment" animated>
          <n-tab-pane name="target" :tab="t('cs_helper.mode.target')">
            <div class="item-selection-container">
              <n-card size="small">
                ...
                <div class="item-btn-container">
                  ...
                  <div class="item">
                    需要制作
                    <div>{{ targetData.requireGreater }}个</div>
                  </div>
                </div>
              </n-card>
              <n-card size="small">
                ...
                <div class="item-btn-container">
                  ...
                  <div class="item">
                    需要制作
                    <div>{{ targetData.requireLesser }}个</div>
                  </div>
                </div>
              </n-card>
            </div>
          ...
          <n-tab-pane name="free" :tab="t('cs_helper.mode.free')">
            <div>
